...
namespace TravelApp.Areas.Admin.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Phone,Email,Facebook,Instagram,Location,Clock")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Phone,Email,Facebook,Instagram,Location,Clock")] Setting setting)
        {
            if (id != setting.Id)
            {
                return NotFound();
